...
evaluation_solver_variants = {
    "SMT-COMP 2014": [
        ...
        ("Abziz", ["abziz_portfolio_all_features default", "abziz_portfolio_min_features default"]),
        ("AProVE", ["AProVE NIA 2014 default"]),
        ("Boolector", ["Boolector boolector", "Boolector boolectord", "Boolector boolectorj"]),
        ("CVC3", ["CVC3 default"]),
        # Inconsistency: thereis also a "fixed resubmission" version
        ("CVC4", ["CVC4 f7118b2 default"]),
        ("Kleaver", ["Kleaver-indie-more-typed kleaver_indie_1", "Kleaver-indie-more-typed kleaver_portfolio"]),
